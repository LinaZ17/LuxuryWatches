                                ...
                                <div class="row">
                                    <div class="col-2 me-one">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ route('showCatalog', $catalog->alias) }}">{{ $catalog->title }}</a></li>
                                            @endforeach
                                        </ul>
    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="col-md-6 footer-right">
                <p>© 2022 Luxury Watches. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
